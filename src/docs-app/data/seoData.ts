...
export const seoDataMap: Record<string, SEOData> = {
  ...
  "/sdk/membership-purchase-widget": {
  ...
  // WordPress Plugin
  "/wordpress/getting-started-install-and-configure": {
  ...
  "/wordpress/adding-single-button-embed-widget": {
  ...
  "/wordpress/adding-event-detail-page": {
  ...
  "/wordpress/adding-calendar-widget": {
  ...
  "/wordpress/adding-membership-list": {
  ...
  "/wordpress/adding-checkout-cart-button": {
  ...
  "/wordpress/advanced-dynamic-cart-counter-jquery": {
  ...
  "/wordpress/widgets-and-affiliate-tracking-links": {
  ...
  "/wordpress/creating-custom-templates": {
  ...
  "/wordpress/automatically-opening-popup-widgets": {
  ...
  "/webhooks/webhooks-setup-and-management": {
  ...
  "/webhooks/webhooks-payload-invoice-object": {
  ...
  "/webhooks/webhooks-logging-and-troubleshooting": {
  ...
  // Google Tag Manager
  "/google-tag-manager/introduction-to-showpass-gtm-integration": {
  ...
  "/google-tag-manager/initial-setup-ga4-and-gtm-basics": {
  ...
  "/google-tag-manager/standard-ecommerce-tracking-with-ga4-via-gtm": {
  ...
  "/google-tag-manager/cross-domain-tracking-considerations": {
  ...
  "/google-tag-manager/working-with-custom-html-and-javascript-in-gtm-for-showpass": {
  ...
  "/google-tag-manager/tracking-custom-conversions-marketing-pixels": {
  ...
  "/google-tag-manager/showpass-data-layer-details": {
  ...
  "/google-tag-manager/advanced-iframe-purchase-tracking-via-postmessage": {
  ...
  "/google-tag-manager/advanced-tracking-widget-and-direct-purchases": {
  ...
  "/google-tag-manager/example-google-ads-conversion-tracking-setup": {
  ...
  "/facebook/introduction-to-facebook-pixel": {
  ...
  "/facebook/installing-facebook-pixel": {
  ...
  "/facebook/about-facebook-conversions-api": {
  ...
  "/facebook/installing-facebook-conversions-api": {
  ...
  "/security/pci-responsibility-matrix": {
