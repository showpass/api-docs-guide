...
| ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `id`                                           | The invoice transaction identifier used for signature verification. Different webhook events can share this value; use `webhook_event_uuid` to deduplicate deliveries.                                                                   |
